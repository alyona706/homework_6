...
document.write(`<p>масив телефонних номерів користувачів в яких баланс більше ніж 2000 доларів ${phoneArr.join('; ')}</p>`);
document.write(`<p>сума всіх балансів користувачів ${sumBalance}</p>`);